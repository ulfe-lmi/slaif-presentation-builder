...
\NoTextSlide{
  ...
  body = {
    ...
    \SlaifFootnotePanel[fill=SlaifPanelBlue]{Podpora: Learnosity (2025) poroča o 9,9 urah ocenjevanja na teden v anketi 258 učiteljev; Schwab et al. (2024) poročajo, da fakultetni učitelji ocenjevanje doživljajo z manj pozitivnimi in več negativnimi čustvi kot raziskovanje in poučevanje; Terada in Merrill (2024) poudarjata, da pogosto ocenjevanje jemlje čas in energijo za izboljševanje pouka.}
  }
}
...
\TwoColumnNoTextSlide{
  ...
  right = {
    \placeimage{555}{178}{345}{301}{stem-baseline-metrics-crop.png}
    \SlaifFootnotePanel[fill=SlaifPanelBlue]{Perš, J., Muhovič, J., Košir, A., \& Murovec, B. (2026). \textit{Grading Handwritten Engineering Exams with Multimodal Large Language Models}. arXiv:2601.00730v1 [cs.CV], 2. januar 2026.}
  }
}
...
\TwoColumnNoTextSlide{
  ...
  right = {
    \placeimage{570}{178}{330}{301}{stem-guidance-ablation-crop.png}
    \SlaifFootnotePanel[fill=SlaifPanelBlue]{Perš, J., Muhovič, J., Košir, A., \& Murovec, B. (2026). \textit{Grading Handwritten Engineering Exams with Multimodal Large Language Models}. arXiv:2601.00730v1 [cs.CV], 2. januar 2026.}
  }
}
...
\TwoColumnNoTextSlide{
  ...
  right = {
    \placeimage{570}{178}{325}{300}{stem-manual-review-triggers-crop.png}
    \SlaifFootnotePanel[fill=SlaifPanelBlue]{Perš, J., Muhovič, J., Košir, A., \& Murovec, B. (2026). \textit{Grading Handwritten Engineering Exams with Multimodal Large Language Models}. arXiv:2601.00730v1 [cs.CV], 2. januar 2026.}
  }
}
