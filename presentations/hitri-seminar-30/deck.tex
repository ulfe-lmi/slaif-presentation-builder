...
\NoTextSlide{
  ...
  body = {
    ...
    \begin{textblock*}{820bp}(80bp,348bp)
      {\RobotoCondensed{}\color{SlaifInk}\fontsize{16.8}{19.8}\selectfont
      \SlaifPlainBulletList{820}{
        \item GitHub repozitorij: \href{https://github.com/ulfe-lmi/slaif-presentation-builder}{https://github.com/ulfe-lmi/slaif-presentation-builder}
