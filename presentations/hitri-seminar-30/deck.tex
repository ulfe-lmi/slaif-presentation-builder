...
\NoTextSlide{
  ...
  body = {
    ...
    \SlaifCommentaryPanel{GitHub}{{\upshape github.com/ulfe-lmi/slaif-presentation-builder}\\[5pt]Učitelj ostane avtor: določi raven razlage, izbriše odvečno, popravi poudarke in potrdi končno sporočilo.}
  }
}
...
\NoTextSlide{
  ...
  body = {
    ...
    \begin{textblock*}{820bp}(90bp,350bp)
      {\RobotoCondensed{}\color{SlaifInk}\fontsize{13.2}{15.6}\selectfont
      {\bfseries Zakaj to ni formalnost}\\[3pt]
      Če tega ni, kasnejša izdelava prosojnic postane ugibanje. Če je to narejeno dobro, učitelj hitro vidi, kaj lahko uporabi.\\[7pt]
      \SlaifPlainBulletList{820}{
