...
\NoTextSlide{
  ...
  body = {
    ...
    \begin{textblock*}{820bp}(80bp,348bp)
      {\RobotoCondensed{}\color{SlaifInk}\fontsize{15.2}{18.0}\selectfont
      \SlaifPlainBulletList{820}{
        \item Github repozitorij: github.com/ulfe-lmi/slaif-presentation-builder
